...
import {kitchenProducts } from './../../Products/Products'; // Import your products array
import './kitchen.css';
import Message from '../../Component/addcartmessage/addcartmsg'; // Import the Message component

const Kitchen_page = ({ searchQuery, isAuthenticated }) => {
  ...
  return (
    <div className="top-products-page">
      <div className="top-products-card">
        <h1 className="heading">Kitchen Items</h1>
