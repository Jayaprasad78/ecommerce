...
import { luggageProducts } from './../../Products/Products'; // Import your products array
import './lugaagage.css';
import Message from '../../Component/addcartmessage/addcartmsg'; // Import the Message component

const Luggage_page = ({ searchQuery, isAuthenticated }) => {
  ...
  const filteredProducts = luggageProducts.filter(product => {
  ...
  return (
    <div className="top-products-page">
      <div className="top-products-card">
        <h1 className="heading">Lugaagage Items</h1>
