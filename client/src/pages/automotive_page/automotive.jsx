...
import { automotiveProducts } from './../../Products/Products'; // Import your products array
import './automotive.css';
import Message from '../../Component/addcartmessage/addcartmsg'; // Import the Message component

const Automotive_page = ({ searchQuery, isAuthenticated }) => {
  ...
  return (
    <div className="top-products-page">
      <div className="top-products-card">
        <h1 className="heading">Automotive Products</h1>
