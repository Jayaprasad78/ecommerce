...
import {  petSupplyProducts } from './../../Products/Products'; // Import your products array
import './petsupply.css';
import Message from '../../Component/addcartmessage/addcartmsg'; // Import the Message component

const Petsupply_page = ({ searchQuery, isAuthenticated }) => {
  ...
  const filteredProducts =  petSupplyProducts.filter(product => {
  ...
  return (
    <div className="top-products-page">
      <div className="top-products-card">
        <h1 className="heading">Pet_Supply Items</h1>
