...
import {stationaryProducts } from './../../Products/Products'; // Import your products array
import './stationary.css';
import Message from '../../Component/addcartmessage/addcartmsg'; // Import the Message component

const Stationary_page = ({ searchQuery, isAuthenticated }) => {
  ...
  const filteredProducts =stationaryProducts.filter(product => {
  ...
  return (
    <div className="top-products-page">
      <div className="top-products-card">
        <h1 className="heading">Stationary Items</h1>
