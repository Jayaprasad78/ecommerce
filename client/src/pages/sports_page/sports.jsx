...
import { sportsProducts } from './../../Products/Products'; // Import your products array
import './sports.css';
import Message from '../../Component/addcartmessage/addcartmsg'; // Import the Message component

const Sportsproduct_page = ({ searchQuery, isAuthenticated }) => {
  ...
  return (
    <div className="top-products-page">
      <div className="top-products-card">
        <h1 className="heading">Sports Items</h1>
...
export default Sportsproduct_page;
